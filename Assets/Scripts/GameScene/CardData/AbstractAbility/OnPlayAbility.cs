...
[System.Serializable]
public abstract class OnPlayAbility: AbilityBase,IRequireTarget
{
    /// <summary>
    ...
    /// <param name="owner"></param>
    /// <returns></returns>
    public PredictedScore Predict(StatusBase owner, List<StatusBase> playerCards, List<StatusBase> rivalCards)
    {
