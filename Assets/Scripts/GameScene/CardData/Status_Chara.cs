...
public class Status_Chara : Status, ICardViewInitializer, IPlayable
{
    ...
    /// </summary>
    public int PlayableCardId => (int)CharaData.PlayableId;
    ...
    /// プレイ時に発動するアビリティー
    /// </summary>
    public IRequireTarget OnPlayAbility => CharaData.OnPlaySkill;
    ...
    public void RequirePlayableId(int? playableId)
    {
        ...
        CharaData.PlayableId = PlayableIdManager.I.GetId(this,ReactivePropertyList.I.FirstAttack, playableId);
    }
    /// <summary>
    /// (通常)ターン開始時に呼ばれる
    /// 攻撃可能回数をリセットする
    ...
    public class Data_Chara:Data
    {
        ...
        /// </summary>
        public IRequireTarget OnPlaySkill { get; private set; }
    ...
    public class RunningAbilities
    {
        public RunningAbilities(CardBook_Chara charaBook)
        {
            ...
            else  //されていない場合
            {
                ...
                OnDefeatedSkill = (charaBook.OnDefeatedSkill is OnDefeatedAbility def) ? def : null; 
                OnTurnEndSkill = (charaBook.OnTurnEndSkill is OnTurnEndSkill turn) ? turn : null;
                BombAbility = (charaBook.BombAbility is BombAbilityBase bomb) ? bomb : null;
