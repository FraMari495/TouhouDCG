...
//{
    ...
    public abstract class CardBook : ScriptableObject
    {
        ...
        [SerializeField] private PrefabInterface<IRequireTarget> onPlayAbility;
        ...
        public IRequireTarget OnPlaySkill => onPlayAbility.GetInterface();
        ...
        private IPlayable MakeCard(bool isPlayer, int? playableId = null)
        {
            ...
            //Debug.LogError("cardObj.GetComponentInChildren<CardForDeckMaking>().gameObject.SetActive(false);");
            cardObj.transform.Find("_ButtonForDeckMaking").gameObject.SetActive(false);
...
{
    void Initialize(bool isPlayer, CardBook book,bool deckMaking = false);
}
