...
namespace WBTutorial
{
    ...
    public class TutorialManager : MonoBehaviour,IPointerClickHandler,IOfflineRival
    {
        ...
        public void StartTutorial()
        {
            ...
            Array.ForEach(parts, p => TutorialQueue.Enqueue(p));
        ...
        public IEnumerator Run()
        {
            if(TutorialQueue.Count == 0)
            {
                ...
                Command.CommandManager.I.Run(new Command.Command_TurnEnd(false));
                yield return new WaitForSeconds(1);
                yield break;
            }
