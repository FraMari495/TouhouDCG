...
namespace Position
{
    public class Field : MonoPair<Field>
    {
        ...
        /// フィールドにカードを追加するメソッド
        /// </summary>
        /// <param name="index">プレイ位置が何番目か</param>
        /// <param name="status">追加したいカード</param>
        //protected override bool AddCard(int index, IPlayable status)
        //{

        //    //cardsに追加
        //    cards.Insert(index, status);
        ...
        public bool Attack(PlayableId attackerId, PlayableId targetId)
        {
            //PlayableIdからカードを特定
           ...
           　
            ...
            if (!isSurpriseAttack) AnimationManager.I.AddSequence(() => AnimationMaker.AttackAnimation(attacker), "攻撃アニメーション");
            else AnimationManager.I.AddSequence(() => AnimationMaker.LockOnAnimation(attacker, target), "攻撃アニメーション");
        ...
        public bool AttackHero(PlayableId attackerPos)
        {
            ...
            if ((Status_Chara)PlayableIdManager.I.GetPlayableById(attackerPos) is Status_Chara attacker)
            {
                ...
                if (!isSurpriseAttack) AnimationManager.I.AddSequence(() => AnimationMaker.AttackAnimation(attacker), "攻撃アニメーション");
                else AnimationManager.I.AddSequence(() => AnimationMaker.LockOnAnimation(attacker, hero), "攻撃アニメーション");
